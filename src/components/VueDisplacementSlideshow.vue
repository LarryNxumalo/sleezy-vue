    ...
    methods: {
        ...
        next(nextImage = null) {
            ...
            this.nextImage =
                nextImage !== null
                    ? nextImage
                    : mod(this.currentImage + 1, this.textures.length);
        ...
        initShaderMaterial() {
            ...
            this.mat = new ShaderMaterial({
                uniforms: {
                    ...
                    texture1: {
                        type: "t",
                        value: this.textures[this.currentImage]
                    },
                    texture2: {
                        type: "t",
                        value: this.textures[this.nextImage]
                    },
        ...
        onResize() {
            ...
            this.camera.aspect =
                this.slider.innerWidth / this.slider.innerHeight;
